...
public class TicketNonUserService {
     ...
     * 비회원 티켓 목록
     */
    public Page<GetUserMemberTicketResponse> list(GetUserNonUserTicketRequest dto, Pageable pageable) {
    ...
    public GetUserMemberTicketDetailResponse detail(Long id, GetUserNonUserTicketRequest dto) {
        Ticket entity = ticketRepository.findByIdAndNonUser_NameAndNonUser_PhoneAndPassword(id, dto.getName(), dto.getPhone(), dto.getPassword())
