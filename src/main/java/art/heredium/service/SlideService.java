...
public class SlideService {
    ...
    public Page<GetAdminSlideResponse> list(GetAdminSlideRequest dto, Pageable pageable) {
        return slideRepository.search(dto, pageable)
                .map(GetAdminSlideResponse::new);
    }
    ...
    public boolean updateOrder(PutAdminSlideOrderRequest dto) {
        ...
        List<Slide> list = slideRepository.search(dto, Math.min(dragOrder, dropOrder), Math.max(dragOrder, dropOrder));
