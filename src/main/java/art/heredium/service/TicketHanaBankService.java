...
public class TicketHanaBankService {
  ...
  public TicketHanaBankUserInfo getTicketHanaBankUserInfo(HanaParamsRequest dto) {
    ...
    try {
      ...
      String hanaData =
          HanaParams.parse(
              PARTNER_KEY, PARTNER_SALT, dto.getMessage(), dto.getMac(), dto.getNonce());
      HanaParamsResponse hanaParamsResponse =
          new Gson().fromJson(hanaData, HanaParamsResponse.class);
  ...
  public Page<GetUserMemberTicketResponse> list(HanaParamsRequest dto, Pageable pageable) {
    ...
    NonUser nonUser =
        nonUserRepository
            .findByHanaBankUuid(ticketHanaBankUserInfo.getHanaBankUuid())
  ...
  public GetUserMemberTicketDetailResponse detail(Long id, HanaParamsRequest dto) {
    ...
    if (entity == null
        || entity.getNonUser() == null
        || entity.getNonUser().getId().longValue() != nonUser.getId().longValue()) {
