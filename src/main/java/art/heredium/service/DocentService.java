...
public class DocentService {
  ...
  public Page<GetAdminDocentDetailResponse.Info> infos(Long id, Pageable pageable) {
    return docentInfoRepository
        .findAllByDocent_IdOrderByOrderAsc(id, pageable)
  ...
  public GetUserDocentInfoResponse infos(Long id) {
    ...
    List<GetUserDocentInfoResponse.Info> infos =
        docentInfoRepository.findPostingInfos(id).stream()
