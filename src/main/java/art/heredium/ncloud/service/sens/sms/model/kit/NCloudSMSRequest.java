  ...
  public void addReceiver(String to, String subject, String content) {
    if (StringUtils.isNullOrEmpty(to)) {
      throw new NCloudKitException(
          NCloudKitErrorCode.SMS_TO_INVALID, "받는이의 연락처는 NULL 혹은 비어있을 수 없습니다.");
    }

    if (StringUtils.isNullOrEmpty(content) && StringUtils.isNullOrEmpty(this.content)) {
      throw new NCloudKitException(
          NCloudKitErrorCode.SMS_CONTENT_INVALID,
          "받는이의 문자 내용은 NULL 혹은 비어있을 수 없습니다. 대안으로 기본 컨텐츠를 삽입해주세요.");
    }
