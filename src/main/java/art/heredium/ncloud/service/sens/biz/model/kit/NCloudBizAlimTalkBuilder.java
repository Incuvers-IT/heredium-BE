...
public class NCloudBizAlimTalkBuilder extends NCloudBizAlimTalkRequestModel {
  ...
  @JsonIgnore private NCloudSENSClient client;

  @JsonIgnore private NCloudBizAlimTalkTemplate template;

  @JsonIgnore private String templateContent;
  ...
  public NCloudBizAlimTalkBuilder(String channelId, String templateCode) {
    ...
    this.client =
        (NCloudSENSClient) ApplicationBeanUtil.getBean(NCloudSENSClient.class.getSimpleName());
   ...
   * @return
   * @link 지원 타임존 목록 : https://en.wikipedia.org/wiki/List_of_tz_database_time_zones, TZ database
   *     name 값 사용
   */
