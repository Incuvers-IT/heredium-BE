...
public enum SmsTemplate {
    TICKET_ISSUANCE("입장권 발급 완료", "헤레디움 입장권 발급 완료", "헤레디움\n" +
            "${title} 입장권이 발급되었어요!\n" +
            "${startDate}\n" +
            "${price}원\n" +
            "${info}\n\n" +
            ...
            "곧 만나요!\n"),
    TICKET_REFUND_USER("입장권 취소(회원)", "헤레디움 입장권 취소", "헤레디움\n" +
            "${title} 입장권이 취소되었습니다.\n" +
            "\n" +
            "${startDate}\n" +
            "${price}원\n" +
            ...
            "전화 : {전화번호} | 이메일 : {이메일}\n"),
    TICKET_REFUND_ADMIN("입장권 취소(관리자)", "헤레디움 입장권 취소", "헤레디움\n" +
            "${title} 입장권이 취소되었습니다.\n\n" +
            "${startDate}\n" +
            "${price}원\n" +
            "${info}\n\n" +
            ...
            "궁금한 사항은 고객센터에서 해결해 드릴게요.\n" +
            "전화 : {전화번호} | 이메일 : {이메일}"),
    TICKET_ISSUANCE_GROUP("단체입장권 발급", "헤레디움 단체입장권 발급", "헤레디움\n" +
            "${title} 단체입장권이 발급되었어요!\n\n" +
            "${startDate}\n" +
            "${price}원\n" +
            "${info}\n\n" +
            "헤레디움 앱에 있는 QR입장권으로 관람을 시작해보세요,\n\n" +
            "곧 만나요!\n"),
    TICKET_REFUND_GROUP("단체입장권 취소", "헤레디움 단체입장권 취소", "헤레디움\n" +
            ...
            "전화 : {전화번호} | 이메일 : {이메일}\n"),
    TICKET_INVITE("초대권 발급", "헤레디움 초대권 발급", "헤레디움\n" +
            "${title} 초대권이 발급되었어요!\n" +
            "\n" +
            "${startDate}\n" +
            "${info}\n\n" +
