...
public enum AlimTalkTemplate {
    ...
    ACCOUNT_NOTY_SLEEP_TERMINATE("자동탈퇴 안내","@heredium", "HEREDIUM010", "@spadecompany", "HEREDIUM010"),
    ...
    AlimTalkTemplate(String title, String prodPlusFriendId, String prodTemplateCode, String devPlusFriendId, String devTemplateCode) {
        this.title = title;
