...
@Getter
@Setter
public class GetAdminCoffeeDetailResponse {
    private Long id;
    ...
    private static class Round {
        ...
        private Round(CoffeeRound entity, Long ticketTotalNumber, Long ticketUsedCount) {
    ...
    public GetAdminCoffeeDetailResponse(Coffee entity, Map<String, Long> ticketTotalNumber, Map<String, Long> ticketUsedCount) {
        this.id = entity.getId();
        this.thumbnail = entity.getThumbnail();
