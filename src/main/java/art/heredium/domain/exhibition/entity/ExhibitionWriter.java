...
public class ExhibitionWriter implements Serializable {
  ...
  public ExhibitionWriter(
      PostAdminExhibitionRequest.Writer dto, Exhibition exhibition, long order) {
    this.exhibition = exhibition;
    this.name = dto.getName();
    this.order = order;
    this.infos =
        IntStream.range(0, dto.getInfos().size())
            .mapToObj(index -> new ExhibitionWriterInfo(dto.getInfos().get(index), this, index))
