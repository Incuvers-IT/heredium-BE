...
public class PostAdminExhibitionRequest {
  ...
  @NotNull private List<PostAdminExhibitionRequest.@Valid Round> rounds = new ArrayList<>();
  @NotNull private List<PostAdminExhibitionRequest.@Valid Price> prices = new ArrayList<>();
  @NotNull private List<PostAdminExhibitionRequest.@Valid Writer> writers = new ArrayList<>();
  ...
  public static class Price {
    ...
    private List<PostAdminExhibitionRequest.Price.@Valid PriceDiscount> discounts =
        new ArrayList<>();
