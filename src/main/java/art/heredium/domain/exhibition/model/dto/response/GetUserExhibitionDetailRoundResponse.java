...
public class GetUserExhibitionDetailRoundResponse {
    ...
    public GetUserExhibitionDetailRoundResponse(Exhibition entity, Map<LocalDateTime, Long> ticketTotalNumber, List<LocalDate> holidays) {
        ...
        this.dates = entity.getRounds().stream()
                ...
                .stream().collect(Collectors.toMap(
                        date -> date,
                        date -> {
                            List<ExhibitionRound> roundsFilterDate = entity.getRounds().stream()
        ...
        this.prices = entity.getPrices().stream()
                .filter(ExhibitionPrice::getIsEnabled).map(Price::new)
                .collect(Collectors.toList());
    }
