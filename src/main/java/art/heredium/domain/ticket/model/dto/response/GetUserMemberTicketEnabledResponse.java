...
public class GetUserMemberTicketEnabledResponse {
    ...
    @QueryProjection
    public GetUserMemberTicketEnabledResponse(Long id, String title, TicketKindType kind, TicketType type, LocalDateTime startDate, LocalDateTime endDate, String uuid, String info) {
        this.id = id;
        this.title = title;
        this.kind = kind;
        this.type = type;
