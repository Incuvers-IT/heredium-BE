...
public class TicketCreateInfo {
    ...
    public TicketCreateInfo(TicketKindType kind, Long kindId, Long roundId, String title, LocalDateTime startDate, LocalDateTime endDate, LocalDateTime roundStartDate, LocalDateTime roundEndDate, Integer limitNumber, LocalDateTime bookingEndDate, Boolean isClose, List<Price> prices, DiscountType discountType) {
        this.kind = kind;
        this.kindId = kindId;
