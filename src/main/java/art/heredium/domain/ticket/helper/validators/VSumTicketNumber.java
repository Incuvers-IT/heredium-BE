...
public class VSumTicketNumber extends AbstractRoundValidator {
    ...
    protected void validate() {
        Long sumTicketNumber = ticketRepository.sumTicketNumber(ticketUserInfo.getAccountId(), ticketUserInfo.getNonUserId(), info.getRoundStartDate(), info.getKind(), info.getKindId());
