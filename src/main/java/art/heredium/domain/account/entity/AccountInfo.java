...
public class AccountInfo implements Serializable {
    ...
    @Comment("마케팅 수신 여부")
    @Column(name = "is_marketing_receive", nullable = false, columnDefinition = "bit(1) DEFAULT false")
    ...
    public AccountInfo(OAuth2UserInfo userInfo, PostNiceIdEncryptResponse info, Boolean isMarketingReceive, Account account) {
        this.auth = AuthType.USER;
        this.name = info.getName();
        this.phone = info.getMobileNo();
        this.isLocalResident = false;
