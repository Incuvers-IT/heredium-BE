...
public class Account implements Serializable {
    ...
    public Account(OAuth2UserInfo userInfo, PostNiceIdEncryptResponse info, OAuth2Provider provider, Boolean isMarketingReceive) {
    ...
    public Account(PostAccountSnsRequest dto, PostNiceIdEncryptResponse info, OAuth2UserInfo userInfo, OAuth2Provider provider) {
        this.email = userInfo.getEmail();
        this.providerType = provider;
        this.snsId = userInfo.getId();
        this.accountInfo = new AccountInfo(dto, info, this);
