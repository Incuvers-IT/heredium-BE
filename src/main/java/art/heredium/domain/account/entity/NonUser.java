...
public class NonUser extends BaseTimeEntity implements Serializable {
    ...
    public void update(TicketHanaBankUserInfo ticketHanaBankUserInfo, PostTicketHanaBankUserCommonRequest dto) {
    ...
    public void update(PostNiceIdEncryptResponse info, PostTicketNonUserCommonRequest postTicketNonUserCommonRequest) {
        this.name = info.getName();
