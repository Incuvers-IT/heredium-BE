...
@Getter
@Setter
public class GetAdminProgramDetailResponse {
    private Long id;
    ...
    private static class Round {
        ...
        private Round(ProgramRound entity, Long ticketTotalNumber, Long ticketUsedCount) {
    ...
    private static class Price {
        ...
        private Price(ProgramPrice entity) {
            ...
            this.discounts = entity.getDiscounts().stream().map(PriceDiscount::new).collect(Collectors.toList());
        }
    ...
    public GetAdminProgramDetailResponse(Program entity, Map<String, Long> ticketTotalNumber, Map<String, Long> ticketUsedCount) {
        this.id = entity.getId();
        this.thumbnail = entity.getThumbnail();
        ...
        this.rounds = entity.getRounds().stream().map(round -> new Round(round, ticketTotalNumber.get(round.getTicketId()), ticketUsedCount.get(round.getTicketId()))).collect(Collectors.toList());
