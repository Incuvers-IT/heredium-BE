...
public class GetUserProgramDetailRoundResponse {
  ...
  public GetUserProgramDetailRoundResponse(
      Program entity, Map<LocalDateTime, Long> ticketTotalNumber, List<LocalDate> holidays) {
        ...
        entity.getRounds().stream()
            ...
            .collect(
                Collectors.toMap(
                    date -> date,
                    date -> {
                      List<ProgramRound> roundsFilterDate =
                          entity.getRounds().stream()
