...
public enum OAuth2Provider implements PersistableEnum<String> {
    ...
    public String getLoginUrl(Map<String, ClientRegistration> registration) {
        ...
        ClientRegistration clientRegistration = this.getClientRegistration(registration.get(this.name().toLowerCase()));
        ...
        UriBuilder uriBuilder = uriBuilderFactory.uriString(clientRegistration.getAuthorizationUri()).queryParams(queryParams);
    ...
    private Map<String, Object> getParameters(ClientRegistration clientRegistration) {
        ...
        if (!CollectionUtils.isEmpty(clientRegistration.getScope())) {
            parameters.put("scope", StringUtils.collectionToDelimitedString(clientRegistration.getScope(), " "));
        }
        return parameters;
    }
    ...
    public Map<String, Object> getUserInfoFromJwt(Map<String, ClientRegistration> registration, String idToken) {
