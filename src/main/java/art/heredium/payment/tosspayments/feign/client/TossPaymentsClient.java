...
public interface TossPaymentsClient {
    ...
    TossPaymentsPayResponse pay(@RequestHeader("Authorization") String authorization, @RequestBody TossPaymentsPayRequest request);

    @PostMapping("/v1/payments/{paymentKey}/cancel")
    void refund(@RequestHeader("Authorization") String authorization, @PathVariable("paymentKey") String paymentKey, @RequestBody TossPaymentsRefundRequest request);
