...
public class TicketImpl implements CreateBody {
    ...
    public List<String> head() {
        List<String> headList = Arrays.asList("NO", "구분", "티켓구분", "제목", "회차", "구매 수", "금액", "계정", "이름", "연락처", "입장권아이디", "결제아이디", "생성일시", "상태");
    ...
    public List<List<String>> body() {
        ...
        for (Ticket entity : list) {
            List<String> asList = Arrays.asList(
                    ...
                    createString(String.format("%s ~ %S", entity.getStartDate().format(dtfm), entity.getEndDate().format(dtfm))),
